...
import { Button, Card, Typography, Space, Input, Select, Form, Row, Col, App, Divider, Alert } from 'antd';
    ...
    <MainLayout>
      <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: 16 }}>
        <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Title level={4} style={{ margin: 0 }}>接入新机器人部件</Title>
        </div>
        <Space>
      ...
      <Row gutter={24}>
        <Col span={16}>
          <Card bordered={false} style={{ borderRadius: 8, minHeight: 'calc(100vh - 180px)' }}>
            <Form form={form} layout="vertical" initialValues={{ topics: [{ name: '', path: '', res: '' }] }}>
              ...
              <Title level={5}>2. ROS Topic 数据通道配置 (重头戏)</Title>
              <Alert 
                message="硬件通讯链路配置" 
        ...
        <Col span={8}>
          <Card bordered={false} title="配置指南" style={{ borderRadius: 8 }}>
